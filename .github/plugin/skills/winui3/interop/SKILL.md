---
name: interop
description: 'COM interop and P/Invoke for WinUI 3 apps — Win32 API access, CsWin32 source generator, window handle interop, and marshaling. Use when calling native Windows APIs from managed code.'
---

# COM Interop & P/Invoke for WinUI 3

Patterns for calling native Windows APIs from WinUI 3 managed code — window handle retrieval, CsWin32 source generation, manual P/Invoke, COM interop, and WinRT bridging.
...
// CsWin32 generates the safe wrapper — no manual DllImport needed
...
- [Call Win32 APIs in Windows App SDK apps](https://learn.microsoft.com/windows/apps/develop/platform/csharp-interop)
- [CsWin32 — .NET P/Invoke source generator](https://github.com/microsoft/CsWin32)
- [Retrieve a window handle (HWND) — WinUI 3](https://learn.microsoft.com/windows/apps/develop/ui-input/retrieve-hwnd)
- [LibraryImport source generation — .NET 7+](https://learn.microsoft.com/dotnet/standard/native-interop/pinvoke-source-generation)
