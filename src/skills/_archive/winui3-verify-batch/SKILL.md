---
name: winui3-verify-batch
description: "Verify WinUI 3 apps by generating and running a batch UI test script — write all tests at once, run them in one pass, read results. Use after building to validate functionality, layout, and accessibility without turn-by-turn screenshot loops."
---
