# action.ps1 — Scaffold a WinUI 3 MVVM project using dotnet new winui-mvvm
...
Write-Host "Scaffolding WinUI 3 MVVM project: $appName"
dotnet new winui-mvvm -n $appName --output "$appDir" --force
...
Write-Host "Done. MVVM project scaffolded at $appDir"
